                    ...
                    <div class="card" style="border-radius: 1rem; height: 580px;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="<?php echo e(asset('images/login.webp')); ?>" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; height: 580px;" />
                            </div>
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="POST" action="<?php echo e(route('login.submit')); ?>">
                                        ...
                                        <div class="form-outline mb-4">
                                            <input type="text" id="username" name="username" required class="form-control form-control-lg" value="<?php echo e(old('username')); ?>" />
                                        ...
                                        <p class="mb-5 pb-lg-2" id="signup" style="color: #393f81;">
                                            Don't have an account? <a href="<?php echo e(route('register')); ?>" style="color: #393f81;">SignUp here</a>
                                        </p>
                                    </form>
...
<?php /**PATH E:\Rahil\This is the place to be\r\prj\resources\views/login.blade.php ENDPATH**/ ?>