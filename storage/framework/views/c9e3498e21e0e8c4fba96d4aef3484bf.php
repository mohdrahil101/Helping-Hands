...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/hire.css')); ?>">
                ...
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="10000">
                            <img src="<?php echo e(asset('images/b1.jpg')); ?>" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="<?php echo e(asset('images/b2.jpg')); ?>" class="d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="bg-primary py-5 px-4 px-sm-5">
                        ...
                        <?php endif; ?>
                        <form class="py-5" id="bookingform" action="<?php echo e(route('services.book')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <input type="text" name="fname" class="form-control border-0 p-4" placeholder="Your Name" value="<?php echo e(old('fname')); ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="email" name="email" class="form-control border-0 p-4" placeholder="Your Email" value="<?php echo e(old('email')); ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="date" class="form-control border-0 p-4" placeholder="Reservation Date (dd/mm/yyyy)" value="<?php echo e(old('date')); ?>">
                            </div>
                            <div class="form-group">
                                <input type="text" name="address" class="form-control border-0 p-4" placeholder="Address" value="<?php echo e(old('address')); ?>" required>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
                    ...
                    <div class="row py-2">
                        <?php $__currentLoopData = ['draining' => 'Drain Cleaning', 'plumbing' => 'Plumbing Repairs', 'sewer' => 'Sewer Line Repair', 'repairs' => 'Emergency Plumbing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-sm-6">
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center mb-2">
                                    <img src="<?php echo e(asset('images/' . substr($img, 0, 1) . '1.jpg')); ?>" class="<?php echo e($loop->even ? 'img2' : 'img1'); ?>" alt="">
                                    <h5 class="text-truncate m-0"><?php echo e($label); ?></h5>
                                </div>
    ...
    <div class="buy container">
        ...
        <div class="row">
            <?php $__currentLoopData = [
                ...
                <div class="col-sm-4">
                    <div class="box">
                        <img src="<?php echo e(asset('images/' . $service['img'])); ?>" class="img-fluid" alt="<?php echo e($service['title']); ?>">
...
<section>
    <div class="second_header">
        <div>
            <div class="img">
                <img src="<?php echo e(asset('images/issue.jpg')); ?>" alt="">
            </div>
            <div class="Overlay"></div>
        </div>
        <div class="Content">
...
<section>
    <div class="container adopt">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="box">
                    <img src="<?php echo e(asset('images/h1.jpg')); ?>" class="img-fluid" alt="">
                    <h5>Alex</h5>
            ...
            <div class="col-sm-4">
                <div class="box">
                    <img src="<?php echo e(asset('images/h2.jpg')); ?>" class="img-fluid" alt="">
                    <h5>Ruby</h5>
                    <p>2 Years Experience <br> consectetur adipisicing elit. Inventore.</p>
                    <button class="btn1">Hire Now</button>
                </div>
            ...
            <div class="col-sm-4">
                <div class="box">
                    <img src="<?php echo e(asset('images/h3.jpg')); ?>" class="img-fluid" alt="">
                    <h5>Ethan</h5>
                    <p>2 Years Experience <br> consectetur adipisicing elit. Inventore.</p>
                    <button class="btn1">Hire Now</button>
                </div>
...
<?php /**PATH C:\Users\sujal\OneDrive\Desktop\lv\prj\resources\views/hire.blade.php ENDPATH**/ ?>