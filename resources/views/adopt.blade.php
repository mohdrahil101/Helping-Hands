...
<body>
                    ...
                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="{{ asset('images/bgg1.jpg') }}" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item" data-bs-interval="2000">
                                <img src="{{ asset('images/bgg2.jpg') }}" class="d-block w-100" alt="...">
                            </div>
                        </div>
        ...
        <div class="container adopt">
            ...
            <div class="row">
                @foreach ([
                    ...
                    <div class="col-sm-4">
                        <div class="box">
                            <img src="{{ asset('images/' . $pet['img']) }}" class="img-fluid" alt="">
                            <h5>{{ $pet['name'] }}</h5>
    ...
    <section>
        <div class="second_header">
            <div>
                <div class="img">
                    <img src="{{ asset('images/backy.jpg') }}" alt="">
                </div>
                <div class="Overlay"></div>
            </div>
            <div class="Content">
